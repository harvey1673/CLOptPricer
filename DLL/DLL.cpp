...
DblVectorOfVectorsOfVectors CLCalibHistBreakevenVol( vector<TimeSeries> &ts_vec, int sprdnum, int expbackdays, int freq)
{
	int numCont = ts_vec.size();
	DblVectorOfVectorsOfVectors res;
	for (int i = 0; i < numCont - sprdnum; ++i)
	{
		DblVectorOfVectors cont;
